...
public class SpecificationServiceImpl implements SpecificationService {
    ...
    //修改一
        ...
        specificationOptionMapper.deleteByExample(example);//获取ID删除

        //添加
        for (TbSpecificationOption specificationOption : specification.getSpecificationOptionList()) {
            specificationOption.setSpecId(specification.getSpecification().getId());//把规格的ID付给规格项里面外键的iD
            specificationOptionMapper.insert(specificationOption);//遍历规格然后一个一个添加
        }
    ...
    //查询规格ID  注入到组合实体类
		...
		TbSpecificationOptionExample example = new TbSpecificationOptionExample();//select * from TbSpecificationOption
